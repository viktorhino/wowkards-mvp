        ...
        <section className="w-full max-w-xl rounded-3xl bg-white/80 backdrop-blur ring-1 ring-black/5 shadow-xl p-8 text-center">
          ...
          <div className="mt-8">
            <Link
              ...
              target="_blank"
              rel="noopener"
              aria-label="Abrir chat de WhatsApp para solicitar Mi Sede WOW"
              className="inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-3 text-base font-semibold text-white bg-[#25D366] hover:bg-[#1ebe57] border-2 border-white shadow-[0_12px_28px_rgba(0,0,0,0.35)] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
            >
              {/* Ícono blanco con mask usando el SVG de /public/icons/whatsapp.svg */}
              <span
                aria-hidden="true"
              ...
              />
              <span>Quiero mi Sede WOW</span>
            </Link>
          </div>

          <p className="mt-4 text-xs text-neutral-600">
            Estamos teniendo mucha demanda; gracias por tu comprensión si no
            respondemos de inmediato. ¡Te atenderemos lo antes posible!
          </p>
        </section>
      </div>
    </main>
